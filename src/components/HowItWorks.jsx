    ...
    "
      >
        ...
        <div className="text-center p-5 space-y-3">
          ...
          <p className="roboto">
            Pick a sustainability challenge that inspires you — from reducing
            plastic use to saving water. Each challenge comes with clear goals
      ...
      "
        >
          ...
          <p className="roboto">
            Monitor your personal and community impact in real time. See how
            much CO₂ you’ve saved, how many resources you’ve conserved, and how
            your efforts contribute to the bigger mission.
          </p>
        </div>
        ...
        <div className="text-center p-5 space-y-3">
          ...
          <p className="roboto">
            Post your tips, experiences, and achievements to motivate others.
            Every shared story multiplies awareness and helps more people live
            sustainably.
          </p>
        </div>
      </div>
