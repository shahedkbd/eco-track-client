...
const AddNewChallenge = () => {
  ...
  return (
    <div className="w-fit py-10 mx-auto shadow-2xl rounded-2xl my-10">
      ...
      <form onSubmit={handleAddChallenge} className="card-body max-w-3xl mx-auto">
  <fieldset className="grid grid-cols-1 gap-4">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      <div>
        ...
        <input type="date" name="startingDate" required className="input mt-1 w-full rounded-4xl" />
      </div>
      <div>
        <label className="text-xs font-bold">End Date:</label>
        <input type="date" name="endingDate" required className="input mt-1 w-full rounded-4xl" />
      </div>
    </div>
    ...
    <div className="grid grid-cols-2 gap-4">
      ...
      <select defaultValue="" required name="MetricPrefix" className="select w-full rounded-4xl">
        <option value="" disabled>Impact Metric</option>
        <option>kg</option>
        <option>km</option>
        <option>kWh</option>
        <option>litre</option>
